...
| Component | Detail |
|-----------|--------|
| Server | Hetzner (Tailscale: `<hem-host>.your-tailnet.ts.net`, `100.x.y.z`) |
| SSH | `ssh root@<hem-host>.your-tailnet.ts.net` |
...
export LOCAL_BACKUP_DEST='root@<workstation>.your-tailnet.ts.net:/root/em-backups'
./scripts/deploy_hetzner.sh --backup-only
