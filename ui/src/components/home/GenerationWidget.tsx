    ...
    return (
      <div class="tlw">
        <div class="tlw-summary">
          ...
          <span class="tlw-summary-label">{dayArg ? `planned solar · realised export · ${dayArg}` : "expected today"}{onSeg && segRate != null ? ` · export paid at ${segRate.toFixed(1)}p/kWh (SEG flat)` : ""}</span>
        </div>
